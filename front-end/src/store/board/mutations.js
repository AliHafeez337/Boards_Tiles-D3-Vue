...
export const SET_SECTIONNAME = (state, sectionName) => { state.sectionName = sectionName };
...
export const SET_SECTIONNAME1 = (state, sectionName) => { state.sectionName1 = sectionName };
