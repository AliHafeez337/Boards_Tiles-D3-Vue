    ...
    getBoard(board) {
      ...
      if (board === 'board1'){
        var sections =  [
          ...
          { 'id': 'azkbug6kyx', 'name': '0ABC', "x": 30, 'y': 50, "color" : "brown", 'backLeft': true, 'backLTitle': 'aaa', 'backRight': false, 'backRTitle': '', 'event_name': 'Event', 'event_due': 1593537002 }, // due in next 3 days
          { 'id': 'atrnrt7tmm', 'name': '1ABC', "x": 260, 'y': 50, "color" : "purple", 'backLeft': false, 'backLTitle': '', 'backRight': true, 'backRTitle': 'ccc', 'event_name': 'Event', 'event_due': 1593882602 }, // due in next 7 days
          { 'id': 'ak693b4ofl', 'name': '0ABC', "x": 530, 'y': 50, "color" : "#DA70D6", 'backLeft': true, 'backLTitle': 'bbb', 'backRight': true, 'backRTitle': 'ddd', 'event_name': 'Event', 'event_due': null } // 1595869802 = due in next 30 days
        ], labels = [
